...
namespace ProjektSitzplan.Design
{
    static class PSColors
    {
        ...
        public static readonly SolidColorBrush ContentTitleForeground = GetColor("D7D8D9");
        ...
        public static readonly SolidColorBrush ContentButtonBorder = GetColor("3B3E45");
        ...
        public static readonly SolidColorBrush MenuDataGridRowBorder = GetColor("2B2E33");
        public static readonly SolidColorBrush MenuDataGridRowHoverBackground = GetColor("32353B");
        public static readonly SolidColorBrush MenuDataGridRowBorderHover = GetColor("32353B");
        public static readonly SolidColorBrush MenuDataGridRowSelectedBackground = GetColor("2B2E33");
        public static readonly SolidColorBrush MenuDataGridRowBorderSelected = GetColor("2B2E33");
        public static readonly SolidColorBrush MenuDataGridRowSelectedForeground = GetColor("FFFFFF");
        public static readonly SolidColorBrush MenuDataGriCellSelectedForeground = GetColor("FFFFFF");
